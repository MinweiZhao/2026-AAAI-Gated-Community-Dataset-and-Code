# train_multimodal_crossattention.py (fixed torch.load issue by using safetensors)
import os
import json
import argparse
import torch
...
from dino_finetune import DINOV2TextCrossAttentionClassifier, DINOV2EncoderLoRA
...
def train(config, encoder):
    ...
    model = DINOV2TextCrossAttentionClassifier(
        encoder=encoder,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--exp_name", type=str, default="multimodal_crossattention")
